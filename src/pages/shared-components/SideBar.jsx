    ...
    return (
        <div className="side-bar" id='side-bar' >
            ...
            <Link to="/">
                ...
                <i className="fa-solid fa-x" onClick={closeSideBar}></i>
            </div>
            <div className="side-nav-links">
                <ul className='' id='nav-ul'>
                    <li className=' nav-li' id='active'><NavLink to={'recommended'} className='a-p'><i className="fa-solid fa-house"></i> الرئيسية</NavLink></li>
                    <li className='nav-li accordion-li'>
                        <div>
                            <Accordion>
                                <AccordionSummary expandIcon={<i class="fa-solid fa-circle-chevron-down"></i>} aria-controls="panel1-content" id="panel1-header">
                                    <Typography><i className="fa-solid fa-share-nodes"></i> <span>شبكة التواصل</span></Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography>
