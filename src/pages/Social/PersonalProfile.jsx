            ...
            <div className="tab-info">
              <div className="about-me">
                <div className="about-head">
                  <h4>نبذة عني</h4>
                  <button>
                    اضافة نبذة <i class="fa-solid fa-circle-plus"></i>
                  </button>
                </div>
                  ...
                  <div className="ps-cont">
                    ...
                    <div className="tabss">
                      <p>
                        <span>
                          {" "}
                          <i class="fa-solid fa-book"></i> 21 درس{" "}
                        </span>{" "}
                        |{" "}
                        <span>
                          {" "}
                          <i class="fa-solid fa-chart-simple"></i> متوسط{" "}
                        </span>
                      </p>
                  ...
                  <div className="card-info">
                    ...
                    <div className="user-react">
                      ...
                      <span className="pro-static">
                        <span>{project.seen}</span> <i class="fa-regular fa-eye"></i>
                        <span>{project.liks}</span> <i class="fa-regular fa-heart"></i>
                      </span>
                    </div>
                    <h4>{project.title}</h4>
                  </div>
